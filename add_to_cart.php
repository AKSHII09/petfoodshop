...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION["user_id"])) {
    ...
    $insert_query = "INSERT INTO cart (user_id, product_id, product_name, description, qty, category, size, price, total_price, img,created_at)
                      VALUES ('$user_id', '$product_id', '$product_name', '$description', '$quantity', '$category', '$size', '$price', '$total_price', '$img','$created_at')";
